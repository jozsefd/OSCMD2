...
int sc_pkcs15emu_esign_qes_init_ex(sc_pkcs15_card_t *p15card,	struct sc_aid *, sc_pkcs15emu_opt_t *opts);
int sc_pkcs15emu_nqapplet_init_ex(sc_pkcs15_card_t *p15card,	struct sc_aid *aid, sc_pkcs15emu_opt_t *opts);
